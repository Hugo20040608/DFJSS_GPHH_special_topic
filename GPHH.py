...
##----------------------
    ...
    # pop, log, time_dict, population_dict, fitness_dict, fitness_evaluations = algorithms.GPHH_experiment2_WS(pop, toolbox, 0.9, 0.1, 50, decision_situations, ranking_vector_ref,n =2, n_offspring=0.5, stats=mstats,
    #                            halloffame=hof, verbose=True)
##----------------------
    pop, log = algorithms.GPHH_new(pop, toolbox, 0.9, 0.1, 10, 10, stats=mstats, halloffame=hof, verbose=True)
...
##----------------------
    ...
    nevals = log.select('nevals') ## milkreo: ????
